...
use Exception;
use dioxid\config\exception\RequiredValNotFoundException;
use dioxid\config\exception\ConfigValueAlreadyExistsException;
use dioxid\config\exception\CantAccessConfigFileException;
